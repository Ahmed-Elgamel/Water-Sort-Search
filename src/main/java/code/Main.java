...
//        System.out.println("Our algorithm answer: " + WaterSortSearch.solve(testCase5Input.toString(), "BF", false));
//        System.out.println();
////
...
//        System.out.println("Our algorithm answer: " + WaterSortSearch.solve(testCase8Input.toString(), "ID", true));
//        System.out.println();
//
////
////        // Test Case 9: Complex Separation
        ...
        System.out.println("Our algorithm answer: " + WaterSortSearch.solve(testCase9Input.toString(), "DF", true));
        System.out.println();
////
//
